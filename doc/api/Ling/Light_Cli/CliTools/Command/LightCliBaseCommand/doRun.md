...
Source Code
===========
See the source code for method [LightCliBaseCommand::doRun](https://github.com/lingtalfi/Light_Cli/blob/master/CliTools/Command/LightCliBaseCommand.php#L41-L41)
